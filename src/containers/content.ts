...
const siteContent = [
  {
    ...
    signUpBtn: 'sign up',
    logOutBtn: 'log out',
    btnToMainPage: 'go to projects',
    btnToHome: 'go to home',
    ...
    incorrectConfirmMsg: 'Does not match',
    incorrectLengthMsg: 'You should use 2 or more signs',
    developers: [
    ...
    taskTitleInputTitle: 'Enter task title',
    taskDescrInputTitle: 'Task description (optional)',
  ...
  },
  {
    ...
    incorrectConfirmMsg: 'Не совпадает',
    incorrectLengthMsg: 'Введите два или более символа',
    developers: [
    ...
    taskTitleInputTitle: 'введите название задачи',
    taskDescrInputTitle: 'Описание задачи (опционально)',
